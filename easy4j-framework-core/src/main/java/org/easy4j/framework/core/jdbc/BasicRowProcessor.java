...
public class BasicRowProcessor implements RowProcessor {
     ...
     *
     * @see RowProcessor#toArray(java.sql.ResultSet)
     ...
     * @see RowProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     * @see BeanProcessor#toBean(java.sql.ResultSet, java.lang.Class)
     ...
     * @see RowProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @see BeanProcessor#toBeanList(java.sql.ResultSet, java.lang.Class)
     * @param <T> The type of bean to create
     * @param rs ResultSet that supplies the bean data
     * @param type Class from which to create the bean instance
     * @throws SQLException if a database access error occurs
     ...
     * @see RowProcessor#toMap(java.sql.ResultSet)
